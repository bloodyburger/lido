...
class ReportsConfig(models.Model):
	...
	show_primary = models.CharField(max_length=3,choices=YN_CHOICES, blank=True,default=None)
	show_secondary = models.CharField(max_length=3,choices=YN_CHOICES, blank=True,default=None)
